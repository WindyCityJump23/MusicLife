  ...
  if (!plays || plays.length === 0) {
    return (
      <div className="border border-dashed border-neutral-300 rounded-xl p-12 text-center space-y-4 max-w-2xl">
        ...
        <div>
          <p className="text-base font-semibold text-neutral-800">No listening history yet</p>
          <p className="text-sm text-neutral-500 mt-1 max-w-xs mx-auto leading-relaxed">
            Your recent Spotify plays show up here once your station setup
            finishes on the <strong>Radio</strong> tab.
          </p>
        </div>
      </div>
    );
