...
export default function PopulateTracksButton({ onComplete }: { onComplete?: () => void }) {
  const { state, message, trigger } = useJobPoller("/api/populate-tracks", onComplete);
  ...
  return (
    <div className="space-y-1.5">
      ...
      >
        {state === "running" ? "Preparing songs…" : "Prepare playable songs"}
      </button>
