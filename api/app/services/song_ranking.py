...
def recommend_songs(
    ...
    # Get tracks from DB for these artists
    tracks_resp = (
        client.table("tracks")
        .select("id,name,artist_id,album_name,duration_ms,popularity,spotify_track_id,explicit")
    ...
    for aid in top_artist_ids:
        ...
        for track in tracks:
            ...
            # Track-level boost: popularity + freshness
